...
export default class Command extends BaseCommand {
    ...
    run = async (M: ISimplifiedMessage): Promise<void> => {
        // fetch result of https://zekais-api.herokuapp.com/randomhusbu? from the API using axios
        const { data } = await axios.get('https://zekais-api.herokuapp.com/randomhusbu?apikey=lZmtOwYX')
